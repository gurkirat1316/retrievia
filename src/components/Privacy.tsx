    ...
    return (
        <main className="min-h-screen bg-gray-50 text-gray-800 py-20 px-6 md:px-16">
            <div className="max-w-5xl mx-auto">
                ...
                <section className="mb-12">
                    <h2 className="text-3xl font-semibold text-gray-900 mb-4">4. Data Security</h2>
                    <p>
                ...
                <section className="mb-12">
                    <h2 className="text-3xl font-semibold text-gray-900 mb-4">5. Sharing Your Data</h2>
                    <p className="mb-4">
                ...
                <section className="mb-12">
                    <h2 className="text-3xl font-semibold text-gray-900 mb-4">6. Cookies and Tracking</h2>
                    <p>
                ...
                <section className="mb-12">
                    <h2 className="text-3xl font-semibold text-gray-900 mb-4">7. Your Rights</h2>
                    <p className="mb-4">
                ...
                <section className="mb-12">
                    <h2 className="text-3xl font-semibold text-gray-900 mb-4">11. Contact Us</h2>
                    <p>
                    ...
                    <div className="mt-4 bg-white shadow-sm rounded-xl p-6 border border-gray-100">
                        ...
                        <p>Email: <a className="text-blue-600 hover:underline">privacy@retrievia.ai</a></p>
                    </div>
                </section>
            </div>
        </main>
