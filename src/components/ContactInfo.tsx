        ...
        <main className="min-h-screen bg-gray-50 text-gray-800 py-20 px-6 md:px-16">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">Have questions about Retrievia, pricing, or enterprise solutions? We would love to hear from you. Our team usually responds within 24 hours.</p>
                </div>
