...
const AboutInfo: React.FC = () => {
    return (
        <>
            <div className="text-center my-16 px-4 sm:px-6 md:px-10 mt-32 mb-24">
                <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent mb-8">
                    Retrievia
                </h1>
            ...
            <div className="px-4 sm:px-6 md:px-10">
                <p className="text-2xl sm:text-3xl md:text-4xl text-center mb-8">Unlock premium features</p>
                <div className="flex flex-col md:flex-row justify-center items-stretch gap-6">
                    <div className="flex-1 rounded-2xl border border-gray-200 shadow-sm p-6 md:p-8 bg-white hover:shadow-md transition">
                        <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-1">Retrievia</h2>
                        ...
                        <button
                            type="button"
                            className="mt-6 w-full md:w-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-10 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none transition"
                        >
                            Get Started for free
                        </button>
                    </div>
                    <div className="flex-1 rounded-2xl border border-gray-200 shadow-lg p-6 md:p-8 bg-white relative overflow-hidden hover:shadow-xl transition mt-6 md:mt-0">
            ...
            <div className='mt-16 text-center px-4 sm:px-6 md:px-10 mb-20'>
                <p className='text-2xl sm:text-3xl md:text-4xl mb-8'>How NotebookLM can work for you and your organization</p>
                <CardHoverEffectDemo />
            </div>
            <Foot />
        </>
